...
public class TeleOP2022 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            rightdrive = magic(rightdrive);
            leftdrive = magic(leftdrive);

            m1DrivePower = leftdrive+m2DrivePowerfordrivetofoundation1+m2DrivePowerfordrivetofoundation11+m2DrivePowerfordrivetofoundation2+m2DrivePowerfordrivetofoundation;

            m2DrivePower = rightdrive+m1DrivePowerfordrivetofoundation1+m1DrivePowerfordrivetofoundation11+m1DrivePowerfordrivetofoundation2+m1DrivePowerfordrivetofoundation;
